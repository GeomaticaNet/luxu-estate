...
export const FeaturedPropertyCard = ({ property }: Props) => {
  ...
  return (
    <Link href={`/propiedades/${property.slug}`} className="block group relative rounded-lg border border-gray-200 overflow-hidden shadow-soft bg-white cursor-pointer transition-all duration-500 hover:shadow-xl hover:-translate-y-1">
